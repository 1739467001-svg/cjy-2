...
<style>
  * { margin: 0; box-sizing: border-box; }
  html, body { width: 920px; height: 1180px; }
  body {
  ...
  .card {
    position: relative; width: 820px; height: 1040px; overflow: hidden;
  ...
  /* header */
  .head { position: relative; z-index: 3; width: 100%; display: flex; justify-content: space-between; align-items: center; margin-bottom: 26px; }
